...
| Model Training Pipeline | guarded LoRA/SFT recipe, YOLO pseudo-label script, traffic PPO/LSTM trainers | H100/5090에서 승인된 background training → eval gate → checkpoint promotion으로 확장 |
| Runtime | RunPod RTX 4090/H100 direct processes | vLLM, vision, orchestrator, simulation, STT/traffic AI를 Docker 없이 실행 |
